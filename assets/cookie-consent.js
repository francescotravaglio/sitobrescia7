        ...
        div.innerHTML =
            '<div style="display:flex;gap:.9rem;align-items:flex-start">' +
                ...
                '<div style="flex:1">' +
                    ...
                    '<p style="color:#6b7280;font-size:.8rem;line-height:1.45;margin:0 0 .9rem">Usiamo cookie tecnici (sempre attivi) e, solo col tuo consenso, Google Analytics per capire come migliorare il sito. Leggi la <a href="privacy" style="color:#003366;font-weight:700;text-decoration:underline">Privacy &amp; Cookie Policy</a>.</p>' +
